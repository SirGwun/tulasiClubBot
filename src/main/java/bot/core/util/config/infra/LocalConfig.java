...
public class LocalConfig implements ConfigProvider {
    private static final ConfigProvider INSTANCE = new LocalConfig();
    ...
    public String get(String key) {
        try (InputStream secretInput = DataUtils.class.getClassLoader().getResourceAsStream("secret.properties")) {
            ...
            LoggerFactory.getLogger(LocalConfig.class)
